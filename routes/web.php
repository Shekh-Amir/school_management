...
Route::get('/create-teachers', 'TeacherController@createTeacher');
Route::post('/store-teachers', 'TeacherController@storeTeacher');
Route::get('/show-teachers', 'TeacherController@showTeacher');
Route::get('/edit-teachers/{id}', 'TeacherController@editTeacher');
Route::post('/update-teachers/{id}', 'TeacherController@updateTeacher');
Route::get('/delete-teachers/{id}', 'TeacherController@destroyTeacher');
...
Route::get('/create-students', 'studentController@createStudent');
Route::post('/store-students', 'studentController@storeStudent');
/*Route::get('/show-students', 'studentController@showStudents');*/
...
Route::get('/create-classgroups', 'ClassgroupController@createClassgroups');
Route::post('/store-classgroups', 'ClassgroupController@storeClassgroups');

/**
 * The Classroom routes
 */

Route::get('/create-classrooms', 'ClassroomsController@createClassrooms');
Route::post('/store-classrooms', 'ClassroomsController@storeClassrooms');
Route::get('/show-classrooms/{id}', 'ClassroomsController@showClassrooms');
